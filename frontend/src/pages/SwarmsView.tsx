    ...
    return (
      <div className="container mx-auto p-6 max-w-3xl">
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-muted-foreground text-sm">No questions of law yet.</p>
          <p className="text-muted-foreground text-xs mt-1">
            Create a swarm with the tag <span className="font-mono text-foreground">question-of-law</span> to get started.
          </p>
        </div>
      </div>
    );
