...
export default function OntologiesView() {
  ...
  const [swarmOntologiesOpen, setSwarmOntologiesOpen] = useState<Record<string, boolean>>({});
    ...
    <div className="container mx-auto p-6 space-y-6 overflow-auto">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="ghost"
              size="icon"
              onClick={() => downloadOntology(CORE_ONTOLOGY, 'hyvmind-core-ontology.ttl')}
      ...
      {swarmOntologies.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold text-foreground">Swarm-Specific Extended Ontologies</h2>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <Collapsible
                    ...
                    onOpenChange={(open) =>
                      setSwarmOntologiesOpen((prev) => ({ ...prev, [swarm.id]: open }))
                    }
                    className="flex-1"
                  >
                    <CollapsibleTrigger className="flex items-center gap-2 hover:text-accent-foreground transition-colors">
