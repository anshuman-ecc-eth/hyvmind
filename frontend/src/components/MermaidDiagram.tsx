...
export default function MermaidDiagram({ mermaidText, onError }: MermaidDiagramProps) {
    ...
    const renderDiagram = async () => {
      ...
      try {
        ...
        if (!mermaidText.trim().startsWith('flowchart') && 
          ...
          throw new Error('Invalid Mermaid diagram type. Must start with a valid diagram declaration (e.g., flowchart, graph, etc.)');
        }
