...
export default function TerminalOntologyOutput({ turtleText, mermaidText, mermaidError }: TerminalOntologyOutputProps) {
  const [copiedTurtle, setCopiedTurtle] = useState(false);
  const [copiedMermaid, setCopiedMermaid] = useState(false);
  const [clientMermaidError, setClientMermaidError] = useState<string | null>(null);
    ...
    <div className="flex flex-col gap-3 my-2">
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs font-mono text-muted-foreground">Turtle (TTL)</span>
          <button
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs font-mono text-muted-foreground">Mermaid Diagram</span>
          {mermaidText && (
            <button
        ...
        {displayError ? (
          ...
          <MermaidDiagram mermaidText={mermaidText} onError={handleMermaidError} />
        ) : (
