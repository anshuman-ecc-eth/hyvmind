...
- After each message, give the player two options:
	- 'continue': continues on the active path-sequence, or 
	- 'retrace': go back one step.
...
- When you encounter a path, render it as a button:
