...
const ABOUT_LINES = [
  ...
  "",
  "But they don't say how it is manufactured, or how their ingredients are sourced.",
  "",
  ...
  "",
  "They're quite helpful with the tedious stuff.",
  "",
  "But they don't understand that legal reasoning can absorb all other forms of reasoning within itself.",
  "",
  "No amount of compute can get them there.",
  "",
  "Also, parrots can't be allowed to make rules for humans.",
  "",
  "That's why we never trust them with the real stuff.",
  "",
  "And the LAI folks hate us for it.",
  "",
  "\"It sends the wrong message\", they say.",
  "",
  "Which is corpspeak for: \"Human thinking reduces our total addressable market.\"",
  "",
  "We've been in the game long enough to see through their PS.",
  "",
