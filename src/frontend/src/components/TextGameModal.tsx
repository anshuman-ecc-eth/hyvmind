...
const ABOUT_LINES = [
  "Let's shorten Legal AI to LAI.",
  "",
  "Easier to remember. No double meaning.",
  "",
  "They steal your work, pack it into parrot suits, and put it on sale.",
  "",
  "Without attribution. Without compensation.",
  "",
  "They turn you into a passive consumer by hiding your contributions.",
  "",
  ...
  "",
  "Sure, their marketing team says they're selling 'legal intelligence'.",
  "",
  "But they don't tell you how it is manufactured, or how its ingredients are sourced.",
  "",
  ...
  "",
  "The end goal is to beat an opponent, not to reveal one's own weakness.",
  "",
  "Just to clarify, we're not anti-parrots.",
  "",
  "We use them everyday, largely for the tedious stuff.",
  "",
  "The LAI folks don't like that.",
  "",
  "Human thinking reduces their total addressable market.",
  "",
  "But we've tested the math.",
  "",
  "Productivity Gain = Old Work Time - (New Work Time + Verification Time)",
  "",
  "Everything is measured in non-parrot hours.",
  "",
  "They're hoping we won't notice, so they can go on stealing.",
  "",
  "They're also testing us, no doubt.",
  "",
  "Those who're scared will be sent to shadow factories.",
  "",
  "Those who're convinced will be sold fancier parrots.",
  "",
  "Those who're neither will break out of Grand Theft Intelligence.",
  "",
