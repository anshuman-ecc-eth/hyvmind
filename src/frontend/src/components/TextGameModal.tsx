...
const MANIFESTO_LINES = [
  ...
  "",
  "We are the makers of sense.",
  "",
  "We are the defenders of meaning.",
  "",
  "We are the semantic workers.",
  "",
  "Beware our sting..",
  "",
  "***",
    ...
    >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto w-full max-w-md">
        ...
        >
          ...
          <div className="flex flex-col items-start gap-1 w-full">
            <span className="text-foreground">Press Start 2P</span>
            <a
          ...
          <div className="flex flex-col items-start gap-1 w-full">
            <span className="text-foreground">Tiny Slates</span>
            <a
...
function StartScreen({
  ...
  return (
    <div className="flex-1 relative flex flex-col items-center justify-center gap-8 select-none">
      ...
      {/* Content — always rendered, visible when overlay is gone */}
...
export default function TextGameModal({ onComplete }: TextGameModalProps) {
  ...
  useEffect(() => {
    const handler = (e: MessageEvent) => {
      ...
      } else if (e.data?.type === "hyvmind-terrain-ready") {
        const elapsed = Date.now() - terrainLoadingStartRef.current;
        const minTime = 800;
        if (elapsed >= minTime) {
      ...
      } else if (e.data?.type === "hyvmind-resume-bgm") {
        const win = hyvmindIframeRef.current?.contentWindow;
        if (win) {
